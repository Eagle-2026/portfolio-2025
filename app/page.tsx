    ...
    <main className="min-h-screen bg-white text-slate-800">
      ...
      <section className="py-24 flex flex-col items-center text-center px-6">
        ...
        <p className="max-w-xl text-slate-500 mb-8">
          ...
          principles, React, Next.js, TypeScript, and GitHub-based development
          practices. <strong>US Citizen – No sponsorship required.</strong>
        </p>
        <a
      ...
      <section id="projects" className="py-10 px-6 bg-slate-50">
        ...
        <div className="max-w-5xl mx-auto grid gap-8 md:grid-cols-3">
          ...
          <div className="bg-white p-6 rounded-xl shadow">
            ...
            <div className="mt-4 text-sm text-slate-600 space-y-2">
              ...
              <p>
                ...
                users, with CRUD operations and protected routes.
              </p>
              <p>
          ...
          <div className="bg-white p-6 rounded-xl shadow">
            ...
            <div className="mt-4 text-sm text-slate-600 space-y-2">
              ...
              <p>
                ...
                filtering and notifications. Deployed to Vercel.
              </p>
              <p>
                <strong>Workflow:</strong> Small, testable improvements verified
                before deployment ensured reliability and maintainability.
              </p>
            </div>
            <div className="flex gap-3 mt-4">
              <a
          ...
          <div className="bg-white p-6 rounded-xl shadow">
            ...
            <p className="text-slate-600 mb-4">
              Multi-step employment form with validation, saved progress, and a
              responsive layout.
            </p>
            <p className="text-sm text-slate-500 mb-4">
            ...
            <div className="mt-4 text-sm text-slate-600 space-y-2">
              ...
              <p>
                ...
                that saves progress and works across devices. Deployed to
                Vercel.
              </p>
              <p>
                <strong>Workflow:</strong> Small, testable changes with
                deployment verification ensured consistent user experience.
              </p>
            </div>
            <div className="flex gap-3 mt-4">
              <a
      ...
      <section className="py-16 bg-slate-800 text-white text-center">
        ...
        <div className="flex justify-center gap-6">
          ...
          <a
            href="https://linkedin.com/in/a-q-f-9b60233a3"
